...
public class DMRCenter implements PlatinumReflection.ActionReflectionListener, IDMRAction {
    ...
    public synchronized void onActionInvoke(int cmd, String value, String data) {
        log.e("onActionInvoke cmd：" + cmd + "value: " + value + "data:" + data);
        switch (cmd) {
    ...
    public void onRenderAvTransport(String value, String data) {
        ...
        log.e("onRenderAvTransport value = " + value + "data： " + data);
    ...
    public void onRenderPlay(String value, String data) {
        log.e("onRenderPlay value = " + value + "data： " + data);
        switch (mCurMediaInfoType) {
            case CUR_MEDIA_TYPE_MUSCI:
                ...
                if (mMusicMediaInfo != null) {
                    ...
                    MediaControlMonitor.getInstance().onPlayCommand();
                }
                clearState();
                break;
    ...
    public void onRenderPause(String value, String data) {
        MediaControlMonitor.getInstance().onPauseCommand();
    }

    @Override
    public void onRenderStop(String value, String data) {
        delayToStop();
        MediaControlMonitor.getInstance().onStopCommand();
    }
    ...
    public void onRenderSeek(String value, String data) {
        ...
        try {
            ...
            MediaControlMonitor.getInstance().onSeekCommand(seekPos);
            ...
            try {
                switch (msg.what) {
                    case MSG_START_MUSICPLAY:
                        ...
                        RenderApplication.getRenderApplication().startPlayMusic(mediaInfo1);
                        break;
...
//                        startPlayPicture(mediaInfo2);
    ...
    private void startPlayMusic(DlnaMediaModel mediaInfo) {
        log.e("startPlayMusic " + mediaInfo);
        RenderApplication.getRenderApplication().startPlayMusic(mediaInfo);
    }
