...
import com.didi365.dlna.widget.BDCloudVideoView;
...
import com.didi365.dlnasupport.center.IMediaControlListener;
import com.didi365.dlnasupport.center.MediaControlMonitor;
...
public class SimplePlayActivity extends Activity implements IMediaPlayer.OnPreparedListener,
        ...
        BDCloudVideoView.OnPlayerStateListener, IMediaControlListener {
    ...
    private void initUI() {
        ...
        MediaControlMonitor.getInstance().setMediaControlListener(this);
    }
